...
<section id="seccion_diseño_web_iconos" class="seccion_padding bg-imagen opacity opacity-blue">
		<div id="div_contenedor_iconos">
			<div class="row justify-content-center text-center">
				<div class="grid-icon -icon col-2 btn" data-toggle="modal" data-target="#materialesAltaCalidadModal">
					...
					<div class="links">
						<nav class="nav justify-content-center">
							<a data-target="#materialesAltaCalidadModal" class="plus portafolio"><i class="fas fa-plus-circle"></i></a>
						</nav>
					</div>
				</div>
				<div class="grid-icon -icon col-2 btn" data-toggle="modal" data-target="#preciosCompetitivosModal">
					...
					<div class="links">
						<nav class="nav justify-content-center">
							<a data-target="#preciosCompetitivosModal" class="plus portafolio"><i class="fas fa-plus-circle"></i></a>
						</nav>
					</div>
				</div>
				<div class="grid-icon -icon col-2 btn" data-toggle="modal" data-target="#respuestaInmediataModal">
					...
					<div class="links">
						<nav class="nav justify-content-center">
							<a data-target="#respuestaInmediataModal" class="plus portafolio"><i class="fas fa-plus-circle"></i></a>
						</nav>
					</div> 
				</div>
			</div>
